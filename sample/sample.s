...
"".main STEXT nosplit size=65 args=0x0 locals=0x20
	...
	0x002c 00044 (sample/sample.go:20)	MOVQ	"".x+8(SP), AX
	0x0031 00049 (sample/sample.go:20)	MOVQ	AX, "".~r1(SP)
	0x0035 00053 (sample/sample.go:20)	JMP	55
	0x0037 00055 (sample/sample.go:20)	PCDATA	$0, $-1
	0x0037 00055 (sample/sample.go:20)	PCDATA	$1, $-1
	0x0037 00055 (sample/sample.go:20)	MOVQ	24(SP), BP
	0x003c 00060 (sample/sample.go:20)	ADDQ	$32, SP
	0x0040 00064 (sample/sample.go:20)	RET
	...
	0x0020 02 00 00 00 48 c7 04 24 00 00 00 00 48 8b 44 24  ....H..$....H.D$
	0x0030 08 48 89 04 24 eb 00 48 8b 6c 24 18 48 83 c4 20  .H..$..H.l$.H.. 
	0x0040 c3                                               .
...
go.debuglines."".main SDWARFMISC size=21
	0x0000 04 02 0a 03 0b 14 9c 24 06 69 06 24 06 69 06 cd  .......$.i.$.i..
